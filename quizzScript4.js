...
const quizArray = [
    {
        id: "0",
        question: "What is the name of the famous Scottish lake that is said to have a monster living in it?",
        options: ["Loch Ness", "Loch Lomond", "Loch Long", "Loch Fyne"],
        correct: "Loch Ness",
    },
    {
        id: "1",
    ...
    },
    {
        ...
        options: ["Unicorn", "Lion", "Dragon", "Bear"],
        correct: "Unicorn",
    },
    {
        id: "3",
        question: "Scotland shares a border with England and is part of _____.",
        options: ["America", "United Kingdom", "France", "Scandinavia"],
        correct: "United Kingdom",
    },
    {
        id: "4",
        question: "Which one of these mountains is the highest point, not only in Scotland, but in the whole of the United Kingdom?",
        options: ["Slieve Donard", "Snowdon", "Ben Nevis", "Scafell Pike"],
        correct: "Ben Nevis",
    },
